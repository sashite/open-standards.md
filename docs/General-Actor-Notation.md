...
Even if this is uncommon, it would be also possible to promote <q>King</q>-like actors; e.g., "`FOO:+-K`" for the <q>promoted King</q> of the Foo variant.
...
* [General Gameplay Notation](General-Gameplay-Notation.md)
* [The Universal Shogi Interface](//www.glaurungchess.com/shogi/usi.html)

<div class="sub-title">Contributing</div>

Want to make this page better?  [Make your changes](//github.com/sashite/specifications.md/edit/master/docs/General-Actor-Notation.md) and submit a hug request.
